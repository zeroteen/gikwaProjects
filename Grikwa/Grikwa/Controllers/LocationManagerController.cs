...
namespace Grikwa.Controllers
{
    public class LocationManagerController : Controller
    {
        ...
        // GET: /LocationManager/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: /LocationManager/Create
